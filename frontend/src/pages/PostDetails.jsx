...
//     try{
//       const res= await axios.get("http://localhost:1111/api/posts/"+postId)
...
//     try{
//       const res=await axios.delete("http://localhost:1111/api/posts/"+postId,{withCredentials:true})
//       console.log(res.data)
//       navigate("/")
...
//     setLoader(true)
//     try{
//       const res=await axios.get("http://localhost:1111/api/comments/post/"+postId)
...
//     e.preventDefault()
//     try{
//       const res=await axios.post("http://localhost:1111/api/comments/write",
    ...
    <div>
      ...
      {loader ? (
        ...
        <div className="px-8 md:px-[200px] mt-8">
          ...
          {post.photo && (
            <img src={post.photo} className="h-96 w-auto mx-auto mt-8" alt="image" />
          )}
